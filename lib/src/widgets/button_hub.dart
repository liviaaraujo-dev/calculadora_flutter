...
class ClearNumberButtonClick extends ButtonClick {
  ClearNumberButtonClick(super.value);
}
    ...
    return GridView.count(
      ...
      children: <Widget>[
        ...
        ButtonNumberClear(
          ...
          onTap: (value) => onButtonClick(ClearNumberButtonClick(value)),
        ),
        Button(
          value: '7',
          onTap: (value) => onButtonClick(CommonButtonClick(value)),
...
class ButtonNumberClear extends StatelessWidget {
  final String value;
  final Color? color;
  final void Function(String value)? onTap;
  const ButtonNumberClear(
      {super.key, required this.value, this.color, this.onTap});
